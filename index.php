...
<body>
    <div id="mobileNav">
        <ul id="mobileNav_ul">
            ...
            <li class="mobileNav_li"><a class="mobileNav_a" onclick="closeMobileMenu(), openIniciarSesion_menu()">Log In</a></li>
        </ul>
    </div>
    <nav id="mainNav">
        <li id="logo"><a href="index.php"><span><img src="content/Nav/nav-images/logo.png" alt="logo" width="200px"></span></a></li>
        <ul id="mainNav_ul">
            ...
            <li class="mainNav_li"><a class="mainNav_a" id="login" onclick="openIniciarSesion_menu()">Log In</a></li>
        </ul>
    ...
    <div id="home">
        <div id="home-text">
            <div id="bienvenidaInicioSesion"></div>
